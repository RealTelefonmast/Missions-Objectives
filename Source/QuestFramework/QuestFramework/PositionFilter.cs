...
namespace StoryFramework
{
    public class PositionFilter
    {
        ...
        public bool IsDefault
        {
            get
            {
                return terrainToAvoid.NullOrEmpty() && terrainToPrefer.NullOrEmpty() && spawnAt.NullOrEmpty() && distanceToThings.NullOrEmpty() && roofs == AreaCheck.Avoid && homeArea == AreaCheck.Avoid;
            }
        }
